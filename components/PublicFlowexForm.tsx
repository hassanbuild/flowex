...
export default function PublicFlowexForm({
  ...
  const handleSubmit = (
    ...
    /*
      The hosted form itself is now real and public.

      We intentionally do not pretend the lead has
      been processed until the customer's storage
      destination is connected in the next Flowex step.
    */

    setSubmitMessage(
      "This Flowex form is ready, but lead routing has not been connected yet."
    );
    ...
    <main className="min-h-screen bg-[#f5f5f5] px-4 py-10 text-gray-900">
      <div className="mx-auto w-full max-w-lg rounded-xl border border-gray-200 bg-white p-6 shadow-sm sm:p-8">
        ...
        >
          ...
          <button
            type="submit"
            className="w-full rounded-lg bg-gray-900 px-4 py-3 text-sm font-semibold text-white transition hover:bg-black"
          >
            Submit
          </button>
        </form>
